    ...
    <div class="cadastro-container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="cpf" name="cpf" pattern="\d{11}" maxlength="11" required>
            </div>
        ...
        <h6 style="margin-top: 10px; color:#555">Já tem cadastro? <a href="login.php" class="link">Faça Login</a></h6>
    </div>
